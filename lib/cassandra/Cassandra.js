...
var Cassandra_cas_args = function(args) {
  this.key = null;
  this.column_family = null;
  this.expected = null;
  this.updates = null;
...
Cassandra_cas_args.prototype.write = function(output) {
  ...
  if (this.commit_consistency_level) {
...
var Cassandra_cas_result = function(args) {
  this.success = null;
  this.ire = null;
  this.ue = null;
  this.te = null;
  ...
  if (this.mutation_map) {
    ...
    for (var kiter331 in this.mutation_map)
    {
      if (this.mutation_map.hasOwnProperty(kiter331))
      {
        ...
        output.writeString(new Buffer(kiter331, 'binary'));
...
var Cassandra_describe_local_ring_args = function(args) {
  this.keyspace = null;
  if (args) {
    if (args.keyspace !== undefined) {
      this.keyspace = args.keyspace;
...
var Cassandra_describe_local_ring_result = function(args) {
  this.success = null;
  this.ire = null;
  if (args) {
    if (args.success !== undefined) {
...
CassandraProcessor.prototype.process_cas = function(seqid, input, output) {
  ...
  input.readMessageEnd();
  var result = new Cassandra_cas_result();
  this._handler.cas(args.key, args.column_family, args.expected, args.updates, args.serial_consistency_level, args.commit_consistency_level, function (success) {
    result.success = success;
...
CassandraProcessor.prototype.process_describe_local_ring = function(seqid, input, output) {
  ...
  input.readMessageEnd();
  var result = new Cassandra_describe_local_ring_result();
  this._handler.describe_local_ring(args.keyspace, function (success) {
    result.success = success;
