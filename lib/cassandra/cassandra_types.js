...
var CASResult = module.exports.CASResult = function(args) {
  this.success = null;
...
var TriggerDef = module.exports.TriggerDef = function(args) {
  this.name = null;
  this.options = null;
  if (args) {
    if (args.name !== undefined) {
